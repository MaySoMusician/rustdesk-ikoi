...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("RustDesk オンライン憩い版 生徒用".to_owned()));
    pub static ref APP_NAME_INTL: Arc<RwLock<String>> = Arc::new(RwLock::new("RustDeskIkoiStudents".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &'static [&'static str] =
    &["rs-ny.rustdesk.com", "rs-sg.rustdesk.com"];
